...
public class Account extends JFrame implements ActionListener {
	...
	public Account() {
		...
		logIn.setBounds(165, 220, 60, 30);
		logIn.addActionListener(this);
		logIn.setFont(new Font("Times New Roman", Font.BOLD, 10));

		JButton createNewAccount = new JButton("Create \naccount");
		createNewAccount.setBounds(105, 255, 180, 30);
		createNewAccount.addActionListener(this);
		createNewAccount.setBackground(new Color(0,0,0,0));
		createNewAccount.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
		createNewAccount.setFont(new Font("Times New Roman", Font.BOLD, 11));
		...
		shoppingCartFrame.add(createNewAccount);
